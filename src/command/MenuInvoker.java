...
public class MenuInvoker { // Оголошення класу
    ...
    public void run() {
        while (true) { // Нескінченний цикл: меню буде показуватися знову і знову після виконання команди
            System.out.println("\n--- MENU ---"); // Виводимо візуальний роздільник/заголовок
            ...
            System.out.print(">> Your choice: "); // Виводимо запрошення до вводу (без переходу на новий рядок)
            ...
            if (key != null) { // Якщо ключ знайдено (тобто команда існує)
                ...
                System.out.println("Unknown command, please try again."); // Виводимо повідомлення про помилку
            }
        }
    }
}